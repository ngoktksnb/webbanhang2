<?php
//Import các file cần thiết, trong đó "inc/myconnect.php" và "inc/function.php" được import vào. Đây có thể là các file chứa các hàm hoặc kết nối đến cơ sở dữ liệu.
...
<html>
<head>
<!-- Phần khai báo HTML, trong đó khai báo các thẻ meta, link CSS và tiêu đề trang. -->
...
<body>
    <?php
    // Bắt đầu một phiên làm việc (session) bằng cách gọi hàm 
    session_start();
    // Import file "include/header.php" vào trang. Đây có thể là một phần header chung được sử dụng trong toàn bộ trang web.
    include('include/header.php');
    ?>
<!-- Đoạn mã PHP để hiển thị slider trên trang. Nó truy vấn dữ liệu từ bảng tb_information trong cơ sở dữ liệu để lấy thông tin về ảnh slider và hiển thị chúng trên trang. Dùng vòng lặp foreach để duyệt qua danh sách ảnh và hiển thị chúng. -->
...
<?php 
// Truy vấn và lấy thông tin từ bảng tb_information trong cơ sở dữ liệu và lưu vào một mảng $array_info.
...
//   Hiển thị các phần nội dung chính của trang web, bao gồm các danh mục sản phẩm và sản phẩm tương ứng với mỗi danh mục. Sử dụng vòng lặp while để duyệt qua các danh mục và sản phẩm và hiển thị chúng.
  extract($array_info);
                ...
                while ($category_c = mysqli_fetch_array($result_category_c, MYSQLI_ASSOC)) {
                    ...
                    <div id="<?php echo $category_c['unaccentname_category']; ?>" class="col-xs-12  product-body themes-product">
                        <div class="row">
                            ...
                            <!-- Hiển thị phần đăng ký nhận thông tin khuyến mãi hoặc sản phẩm mới nhất. Bao gồm một biểu mẫu và sử dụng phương thức POST để gửi dữ liệu. -->
                                <div class="pre"></div>
                                <div class="next"></div>
                            </div>
    ...
    <!-- <div class="container">
        <div class="row">
            <div class="col-xs-12 text-center">
                ...
                <div>Thông tin này sẽ được bảo mật trên hệ thống Fashion</div>
                <div>Hệ thống sẽ tự động gửi thông tin khuyến mãi hoặc sản phẩm mới nhất về thời trang nam nữ về email
                    mà
                    bạn đã đăng ký
                </div>
...
<div class="container">
    <!-- <div class="row">
       ...
       <div class="col-md-8 col-xs-12 footer-content"> 
            ...
            <p>3T SHOP(R) giới thiệu đến các bạn các mẫu quần áo nam đẹp, kiểu dáng thời trang, kiểu quần áo nam thời
                trang
                Hàn Quốc, phong cách thời trang 2017<br>
                Thương hiệu thời trang nam 3T SHOP(R) luôn hướng đến những sản phẩm quần áo nam chất lượng, cao cấp,
                kiểu
            ...
            <p>Khi chọn được các mẫu style quần áo nam thời trang đẹp và ưng ý, các bạn nhớ đặt hàng mùa sản phẩm
                quần
                áo thời trang nam tại website để 3T SHOP được tư vấn chính xác hơn về chất lượng cũng như chi phí giao
                hàng
            đến tận tay cho các bạn</p>

            <h4>Mua quần áo nam thời trang tại 3T SHOP</h4>
            <p>Đến với 3T SHOP(R) chắc chắn bạn sẽ chọn được mẫu quần áo nam đẹp và ưng ý.<br>
                Khi chọn mua sản phẩm quần áo nam chúng tôi sẽ có nhân tư vấn và giao hàng đến tận nơi cho quí
                khách.
                3T SHOP(R) giao hàng trên toàn quốc, tùy thuộc vào địa điểm giao hàng mà phí ship hàng có giá trị khác
                nhau
                Nếu tổng giá trị đơn hàng lớn hơn 1 triệu đồng, chúng tôi sẽ ship hàng miễn phí cho quí khách<br>
            Xin cảm ơn quí khách.</p>

            <p>3T SHOP hân hạnh được phục vụ các bạn</p>
       </div> 
    </div> -->
</div>
</div>
