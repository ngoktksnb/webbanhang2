...
<div id="footer-header" style="background: #FFFFFF;">
	<div class="container">
		<div class="row" style="background: # 00BFFF;padding: 25px 0">
			...
			<div class="col-xs-12 col-sm-5 wapper1">
				...
				<p class="nd" style="background: #FFFFFF; color: #000000;">
					<?php
			...
			<div class="col-xs-12 col-sm-offset-1 col-sm-3 wapper2" style="background: #FFFFFF;">
				<h3 style="color: #000000;" ><span><i class="glyphicon glyphicon-list-alt"></i></span>
					Danh mục
				</h3>
				<ul>
					<?PHP 
					...
					foreach ($array as $value) {
						$value = explode("-+&", $value);
						?>
						<li><span><i class="glyphicon glyphicon-ok"></i></span><a href="sp-category.php?category=<?php echo $value[0]; ?>" style="color: #000000;text-decoration: none;text-transform: capitalize;"><?php echo $value[1]; ?></a></li>
						<?php
					}
					?>
				...
				<div class="col-xs-12 col-sm-3 wapper3" style="background: #FFFFFF;">
					<h3 style="color: #000000;"><span><i class="glyphicon glyphicon-envelope"></i></span>
						Liên hệ
					</h3>
					<ul>
						<!-- query email -->
						...
						if( mysqli_num_rows($result_email) > 0 ) { 
							...
							foreach ($array_email as $value) {
								?>
								<li style="color: #000000;"><span><i class="glyphicon glyphicon-envelope"></i></span><span style="font-family: 'Open Sans Bold';background: none; color: #000000">Email:</span> <?php echo $value; ?></li>
								<?php 
							}
						}
						?>
						...
						if( mysqli_num_rows($result_adress) > 0 ) { 
							...
							foreach ($array_adress as $value) {
								?>
								<li style="color: #000000;"><span><i class="glyphicon glyphicon-map-marker"></i></span>Địa chỉ <?php echo $value; ?></li>
								<?php 
							}
						}
						?>
	...
	<footer>
		<div class="container">
			<div class="row">
				...
				<div class="div-footer">Copyright 2024· by <span>Fashion</span> All rights reserved</div>
			</div>
		</div>
	</footer>
