...
?>
<!-- Thêm nút thanh toán tại đây -->
<div class="checkout-button" style="text-align: right;">
    <a href="thongtingiohang.php" class="btn btn-primary">Thanh toán</a>
</div>
...
<!---->
<!-- <div id="themes">Tùy chỉnh 123</div> -->
...
<!-- <div id="themeContainer">
    <div class="wrapper-style">
        ...
        <div class="oregional-skins">
            <div class="item-oregional-skins">
                ...
                <div id="# 00BFFF" class="item-oregional-skins-x"></div>
  ...
  -->
<!-- tùy chỉnh kích thước trên các màn hình bằng boostrap -->
