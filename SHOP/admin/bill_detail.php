       ...
       <!--   <div class="titile">
        ...
        <table class="table table-striped"> 
          ...
          <tbody>
            <!--  -->
            <?php 
            // Nếu bạn đang sử dụng các biến không được khai báo như "$_GET['code_order']" và "$_GET['code_bill']", hãy bỏ comment (loại bỏ dấu // ở đầu dòng) các dòng tương ứng để lấy dữ liệu từ URL.
            ...
            while ($order = mysqli_fetch_array($result, MYSQLI_NUM)) {
              ...
              <tr style="<?php echo ($check_product) ? 'color: #bd0103' : '';?>">
                ...
                <td>
                  <?php 
                  //Nó thực hiện một truy vấn SQL để lấy thông tin chi tiết của hóa đơn dựa trên mã hóa đơn.
              ...
              <!-- Với mỗi dòng dữ liệu, nó kiểm tra tình trạng của sản phẩm bằng cách sử dụng hàm check_product(). Nếu sản phẩm không đủ hàng, nó sẽ đặt màu chữ đỏ cho dòng tương ứng. -->
           ...
           ?>
           <tr>
            <!-- Cuối cùng, nó tính tổng tiền của hóa đơn và hiển thị nút "Quay về danh sách hóa đơn" -->
