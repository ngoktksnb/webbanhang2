...
<div class="row">
    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
        ...
        if (isset($_POST['submit'])) {
            ...
            $status = $_POST['status'];
            if (empty($errors)) {
                // lay duong dan anh co san
                if ( isset($_POST['anh_hi']) && !empty($_POST['anh_hi']) ) {
                 foreach ($_POST['anh_hi'] as $key => $value) {
                    $link_image .= $value . " ";
                   }
               }
               if ( isset($_POST['anhthumb_hi']) && !empty($_POST['anhthumb_hi']) ) {
                 foreach ($_POST['anhthumb_hi'] as $key => $value) {
                        $link_image_thump .= $value . " ";
                   }
               }
                // kiem tra xem co nhan anh mới khong
       ...
       <div class="form-group">
        ...
        <input type="text" name="price_product" value="<?php echo number_format($dong['price_product']); ?>" class="form-control"
    ...
    <div class="form-group">
        ...
        <input type="text" name="saleprice_product" value="<?php echo number_format($dong['saleprice_product']); ?>" class="form-control"
    ...
    <div class="form-group">
        ...
        <textarea rows="7"  name="describe_product" value="" class="form-control"><?php echo $dong['describe_product']; ?></textarea>
    </div>
