...
<table class="table table-hover">
    ...
    <body>
        <?php 
        //Khởi tạo một mảng $array_product để lưu trữ các sản phẩm có số lượng hàng còn lại bằng 0.
        $array_product = array();
        ...
        while ($product = mysqli_fetch_array($result_product, MYSQLI_ASSOC)) {
            ...
            //Nếu số lượng hàng còn lại bằng 0, thêm sản phẩm vào mảng $array_product.
