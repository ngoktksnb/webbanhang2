...
<head>
    ...
    <script type="text/javascript">
        //Phần này bao gồm mã JavaScript và HTML. Nó đầu tiên khai báo một hàm initialize() để tạo bản đồ Google và đánh dấu vị trí của cửa hàng trên bản đồ. Sau đó, có một biến myKey chứa khóa API của Google Maps. Tiếp theo, có một hàm loadScript() để tải kịch bản API Google Maps và gọi hàm initialize() khi tải xong.
        function initialize() {
