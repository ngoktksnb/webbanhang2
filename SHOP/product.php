...
<html>
<head>
    <title>Quần áo nam đẹp, quần áo hàng hiệu, cao cấp kiểu 2024</title>
    ...
    <style>
/* Thay đổi màu nền của nút "Mua ngay" */
.buy-mua .dk-mua.dki-mua {
    background-color: white !important; /* Màu nền trắng */
    color: black !important; /* Màu chữ đen */
}

/* Thay đổi màu nền của nút "Thêm vào giỏ hàng" */
.buy-mua .dk-mua.add-to-cart {
    background-color: white !important; /* Màu nền trắng */
    color: black !important; /* Màu chữ đen */
}
...
while ($product = mysqli_fetch_array($result_sp, MYSQLI_ASSOC)) {
    ?>
    <div class="see-product" style="background: black; " product="<?php echo $product['id_product']; ?>">
        <div class="container container-see">
            <div class="row">
                ...
                <div class="col-sm-7 col-xs-12 right">
                    ...
                    <hr>
                    <p style="font-weight: 700;color: #fff;text-decoration: underline;">Mô Tả Chi Tiết Sản Phẩm:</p>
                    <p id="quickBuyHighlight"><?php echo $product['describe_product']; ?></p>
                    <hr>
                    <div class="col-sm-6 col-xs-12">
                        <div class="row">
                            <div style="color: #fff">Chọn Size<span style="font-size: 10px">*</span></div>
                    ...
                    <div class="col-sm-5 col-sm-offset-1 col-xs-12">
                        <div class="row">
                            <div style="color: white">Chọn Số Lượng<span style="font-size: 10px">*</span></div>
                    ...
                    <div class="col-xs-12 diachi">
                        ...
                        ?>
                            <li>(Ngoài mua hàng tại web của fashion khách hàng
                                <?php
                            ...
                            ?>  còn có thể trực tiếp đến cửa hàng tại địa chỉ
                                55 Giải Phóng để trực tiếp thử đồ và mua hàng)
                            </li>
                        </ul>
                    </div>
                    <hr class="col-xs-12">
                    <div class="col-xs-12">
                        <div class="row  cam-ket">
                            ...
                            thiết kế theo xu hướng thời trang 2024 của thương hiệu  <?php
                            $query_description = 'SELECT value FROM tb_information WHERE name = "name"';
                            $result_description = mysqli_query($dbc, $query_description);
                            if( mysqli_num_rows($result_description) > 0 ) {
                                extract( mysqli_fetch_array($result_description, MYSQLI_ASSOC) );
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="product-list">
                <div class="left">
                    <h2><a href="sp-category.php?category=<?php echo $id_category; ?>">XEM THÊM SẢN PHẨM TƯƠNG TỰ</a></h2>
                </div>
                <div class="right">
...
//        hàm gọi session trong ở cuối trang index
    ...
    ?>" product="<?php echo $product['id_product']; ?>">
            ...
            <div class="modal-dathang"  style="background-color: black; color: white;">
                <div class="col-xs-12 name-dt" style="color: white;"><?php echo $product['name_product'];?>
                    <div class="close-dt">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-9">
                        ...
                        <div class="col-sm-6 col-xs-12" style="margin-bottom: 10px">
                            <div class="row">
                                <div style="color: #FFFFFF;font-weight: 700;margin-bottom: 5px">Size<span style="font-size: 10px">*</span></div>
                                <div class="col-xs-12 option1">
                                    <div class="row">
                                        <select name="size-dt" class="select size-dt select-size" style="text-transform: uppercase; color: black;">
                        ...
                        <div class="col-sm-5 col-sm-offset-1 col-xs-12">
                            <div class="row">
                                <div style="color: #FFFFFF;font-weight: 700;margin-bottom: 5px">Số lượng<span style="font-size: 10px">*</span></div>
                                <select name="soluong-dt" class="select select-soluong soluong-dt col-xs-12" style="color: black;">
